...
- New filter options for templates! Now you can refine your _[!UICONTROL Select templates]_ list in [!DNL Create] and in _[!UICONTROL Content]_ > _[!UICONTROL Templates]_. See [Search templates](/help/user-guide/content/use-templates.md#manage-templates). Ensure that templates are properly tagged with metadata to make them discoverable through these filters.
