...
* Added support for [publishing ad experiences](/help/user-guide/activation/overview.md) directly from _[!DNL Content]_ into Google Campaign Manager 360 and Meta Ads Manager.
