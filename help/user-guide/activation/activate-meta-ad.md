...
>[!NOTE]
>
>If the ad set is successfully created but the ad set name could not be saved, edit the ad set name. You can still access the new ad set in Meta Ads Manager. 
>
