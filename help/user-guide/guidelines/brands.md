...
| On-image sub-text 1    | LinkedIn | General guidelines define the overall tone/emotion consistently throughout. | Provide specific guidance (2-5 descriptive phrases) to help interpret general tone. Add previously successful text to _Examples_ section for better quality output.<br>_Examples_: "Avoid overly formal language"|
| On-image sub-text 2    | LinkedIn | General guidelines define the overall tone/emotion consistently throughout. | Provide specific guidance (2-5 descriptive phrases) to help interpret general tone. Add previously successful text to _Examples_ section for better quality output.<br>_Examples_: "Use a creative and quirky tone"|
