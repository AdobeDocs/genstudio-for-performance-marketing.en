...
1. Headlines
1. On-image text
1. The brand validation process occurs and the [_Brand and accessibility check_](/help/user-guide/guidelines/brand-validation.md#brand-and-accessibility-check) populates for each variant.
