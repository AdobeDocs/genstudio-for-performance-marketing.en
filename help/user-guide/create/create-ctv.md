---
title: Create a Connected TV Experience
description: Learn how to create connected TV (CTV) ads in Adobe [!DNL GenStudio for Performance Marketing]—from brief and assets through generation, scene editing, review, and export.
feature: Create Canvas, Create Prompt, Generative AI, Variant Generation, Content Generation
role: User
level: Beginner
---

# Create a connected TV experience

Use [[!DNL Create]](/help/user-guide/create/overview.md) in [!DNL GenStudio for Performance Marketing] to build connected TV (CTV) ads in one place—from brief and shared guidelines through generation, scene-based refinement, approval, and publisher-ready export. The workflow below runs entirely in [!DNL GenStudio for Performance Marketing]; there is no separate CTV app or publisher embed.

## Prerequisites

Before you create a CTV ad, confirm the following:

* Access to [!DNL GenStudio for Performance Marketing].
...
* Interprets the brief together with context from **[!DNL Brands]**, **[!DNL Products]**, and **[!DNL Personas]**.
* Assembles a full CTV ad structure.
* Creates scenes, text overlays, music, and voiceover as needed.
* Applies CTV-compliant duration and formatting.

The result is a fully formed, previewable CTV ad—not a bare draft timeline.

## Edit and refine the ad
...
>[!NOTE]
>
>The editor does not support changing objects *inside* a video clip (for example, removing items, changing product colors, or altering how people appear).

## Review and approve

Submit the ad for brand review using your integrated approval workflows. Brand and stakeholder reviewers check messaging, visuals, and brand compliance. Approvers validate the ad; they are not expected to perform video editing in place of the marketer.

## Export

After approval, you can:

* Export the finalized CTV ad in a publisher-ready, compliant format.
* Save the ad back to [!DNL Content].
* Use it in downstream CTV buying and trafficking workflows.

Creative is intended to be ready for activation without re-encoding or rework.
