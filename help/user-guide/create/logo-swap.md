...
![Search logos by brand name](./logo-name-search.png){width="300"}
1. Or use a filter search to find a logo.
![Filter logos](./logo-filter-search.png){width="300"}
