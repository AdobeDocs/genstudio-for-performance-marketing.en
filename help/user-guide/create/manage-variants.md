...
1. Click the **[!UICONTROL Replace image]** icon.
1. Use the filters and search function in the GenStudio assets [!DNL Content] view that appears to further narrow your search results.
