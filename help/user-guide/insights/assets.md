...
| **[!UICONTROL CPA]**<br>_Cost per Action_ | Average cost ($) for a specific customer action, such as a purchase or subscription.<br>**Calculation**: total amount `spent` divided by the number of customer actions completed | Helps to identify assets that result in valuable customer actions. |
