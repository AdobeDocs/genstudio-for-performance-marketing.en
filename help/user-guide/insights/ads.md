...
| **[!UICONTROL Media]** | The number of assets used in the ad or ad. | The count in the Ads table may be different than the count in the Ad details view. This discrepancy can occur if the channel source, such as Meta, and GenStudio use slightly different summary calculations. |
